...
void handle_Preferences_Page1_Values(void)
{
    ...
    switch (themeId) {
        case OSD_THEME_CLASSIC: OSD_writeStringAtRow(1, 19, "Classico"); break;
        ...
        default:                OSD_writeStringAtRow(1, 19, "Desconhecido"); break;
    }
